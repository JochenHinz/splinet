...
def wire(y0=0.5, r=0.4, nelems=8):
  ...
  # face_indices[(0, 0)] = [[19, 1, -20, -8]]
  # face_indices[(1, 0)] = [[21, 3, -22, -12]]
  # face_indices[(2, 0)] = [[23, 5, -24, -16]]

  face_indices[2] = list(range(7, 11))
  face_indices[3] = list(range(11, 15))
  face_indices[4] = list(range(15, 19))

  face_indices[1] = [1, 2, 3, 4, 5, 6]

  faces = {1: [2], 2: [3], 3: [4], 4: [1, 2, 3, 4]}

  network = EdgeNetwork(list(range(1, len(edges)+1)), edges, face_indices, faces=faces)
