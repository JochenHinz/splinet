...
from template import MultiPatchTemplate, infer_knotvectors, \
                     OrderedBoundaryEdgesMixin, get_edges, multipatch_boundary_edges, \
                     patches_verts_to_network, silhouette, get_patch_edges
from mapping import go, mul
from nutils import mesh, function, log, numeric, util, topology
import itertools
